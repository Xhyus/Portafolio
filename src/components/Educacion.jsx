    ...
    return (
        <VStack id='Educacion'>
            ...
            <Wrap spacing={10} justify={"center"}>
                ...
                <WrapItem>
                    <CardEducacion logo={'https://upload.wikimedia.org/wikipedia/commons/a/a2/Escudo_Universidad_del_B%C3%ADo-B%C3%ADo.png'} institucion={'Universidad del Bío-Bío'} descripcion={'Ingeniería en Ejecución Informática'} ingreso="2019" egreso="-" size={"30%"} />
                </WrapItem>
            </Wrap>
        </VStack>
    )
